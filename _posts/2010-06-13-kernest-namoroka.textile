...
layout: post
---
While trying out @@font-face@ and "Kernest":http://kernest.com/, I ran into a rather weird issue. Viewing the site in my default browser, Firefox, would reveal a rather unappealing site with generic sans-serif fonts, and a header saying "your browser doesn't support @@font-face@". Wait, what? My browser? I'm pretty confident that Firefox 3.5+ does indeed supoort @@font-face@... Let's try this on chrome...
